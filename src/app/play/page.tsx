...
function PlayPageClient() {
  ...
  const parseExtinfDuration = (line: string): number => {
  ...
  const isLikelyAdUri = (uri: string): boolean => {
    if (!uri) return false;
