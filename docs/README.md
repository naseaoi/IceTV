...
部署与环境变量看仓库根目录 [README.md](../README.md)，环境变量样例看 [.env.example](../.env.example)。

各文档职责不重叠：`AGENTS.md` 记**约束**，`messages-tracking-decisions.md` 记**决策依据**，`release.md` 记**流程**，`performance-baseline.md` 记**方法**。实现细节看代码，改动历史看 git log。
